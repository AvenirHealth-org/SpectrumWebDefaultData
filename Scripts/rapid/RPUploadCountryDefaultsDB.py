...
RP_DB_tag_columns = {
    ...
    rpdbc.RP_COST_F_STERILIZATION_DB_TAG            : gbc.GB_NOT_FOUND,
    rpdbc.RP_COST_M_STERILIZATION_DB_TAG            : gbc.GB_NOT_FOUND,
    ...
    rpdbc.RP_COST_VAG_BARR_DB_TAG                   : gbc.GB_NOT_FOUND,
    rpdbc.RP_COST_OTHER_MODERN_DB_TAG               : gbc.GB_NOT_FOUND,
